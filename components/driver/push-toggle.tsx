...
// Lets a driver opt into Web Push so a newly assigned parcel pings their phone
// even when the app is closed. Renders nothing when push isn't configured on
// the server (no VAPID key) or the browser can't do push.

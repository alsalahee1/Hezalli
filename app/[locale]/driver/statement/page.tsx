...
// The driver's monthly statement (docs §30): opening → entries → closing for
// both earnings and COD cash — the v1.12 hub statement for the driver's books.
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between rounded-xl border p-2">
        <Link
          href={`/driver/statement?month=${shift(-1)}`}
      ...
      <a
        href={`/api/driver/statement?month=${key}`}
